 ...
 */
function computeEarningsQuality(stmt, config = runtime_1.EARNINGS_QUALITY_CONFIG) {
    var _a;
    const flags = [];
    let evaluated = false;
    ...
    const revenueBase = revenueFromOps !== null && revenueFromOps !== void 0 ? revenueFromOps : totalRevenue;
    const netMargin = (_a = num(stmt.netMargin)) !== null && _a !== void 0 ? _a : (netProfit !== undefined && revenueBase !== undefined && revenueBase > 0
    ...
    if (netMargin !== undefined && prevNetMargin !== undefined) {
        ...
        const revGrowth = prevRevenueFromOps !== undefined && prevRevenueFromOps > 0 && revenueFromOps !== undefined
 ...
 */
exports.nullFundamentalsSource = {
    name: 'none',
    async fetchLatestStatement() {
        return null;
    },
};
//# sourceMappingURL=earningsQuality.js.map