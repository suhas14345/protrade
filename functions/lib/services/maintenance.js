 ...
 */
exports.cleanupData = (0, https_1.onRequest)({ timeoutSeconds: 540, memory: '512MiB' }, async (req, res) => {
    const db = getDb();
    const results = {};
    try {
        // 1. Delete all jobs
 ...
 */
exports.auditJobs = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    const db = getDb();
 ...
 */
exports.purgeJobs = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    const db = getDb();
    try {
