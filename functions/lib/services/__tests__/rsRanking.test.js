 ...
 */
function computeComposite(ret20d, ret60d) {
...
describe('RS Ranking — score threshold filters', () => {
    ...
    function getRsBoost(rsScore) {
        if (rsScore >= RS_CONFIG.SCORE_BOOST_TIER2)
            return RS_CONFIG.BOOST_TIER2_PTS;
        if (rsScore >= RS_CONFIG.SCORE_BOOST_TIER1)
            return RS_CONFIG.BOOST_TIER1_PTS;
        return 0;
    }
...
describe('RS Ranking — full universe sort', () => {
    ...
    it('strongest performer gets rsScore 99', () => {
        ...
        expect(best === null || best === void 0 ? void 0 : best.symbol).toBe('A');
    });
    it('weakest performer gets rsScore 0', () => {
        ...
        expect(worst === null || worst === void 0 ? void 0 : worst.symbol).toBe('C');
    });
...
//# sourceMappingURL=rsRanking.test.js.map