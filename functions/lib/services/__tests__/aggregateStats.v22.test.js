...
function computeSortino(dailyReturns, riskFreeRate = 0) {
    if (dailyReturns.length < 2)
        return 0;
    const mean = dailyReturns.reduce((s, r) => s + r, 0) / dailyReturns.length;
...
function computeCalmar(annualReturn, maxDrawdown) {
    if (maxDrawdown === 0)
...
describe('Equity curve peak tracking', () => {
    function updatePeak(currentEquity, peakEquity) {
...
//# sourceMappingURL=aggregateStats.v22.test.js.map