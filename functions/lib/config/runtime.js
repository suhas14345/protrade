...
exports.ADV_LIMITS = {
    ...
    MIN_ORDER_VALUE_INR: 50000, // Minimum ₹50K order value to avoid noise
    MIN_TRADED_VALUE_20D: 5000000, // Reject if 20d median traded value < ₹50L
    // V2.4: Absolute position size cap
    MAX_POSITION_VALUE_INR: 20000000, // Max ₹2Cr per position regardless of sizing
};
// V2.3: Short strategy controls
exports.SHORT_CONFIG = {
    ...
    INSTRUMENT: 'FUTURES', // 'FUTURES' = stock futures only (no naked cash shorts)
...
exports.RS_STRATEGY_THRESHOLDS = {
